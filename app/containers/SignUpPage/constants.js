...
export const GET_STYLES_REQUEST = 'wm/SignUp/GET_STYLES_REQUEST';
export const GET_STYLES_SUCCESS = 'wm/SignUp/GET_STYLES_SUCCESS';
export const GET_STYLES_FAIL = 'wm/SignUp/GET_STYLES_FAIL';
